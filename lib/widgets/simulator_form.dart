                    ...
                    child: ElevatedButton(
                      ...
                      onPressed: () {
                        context.read<SimulatorProvider>().updateSimulatorInfo(
                              poland1:
                                  int.tryParse(poland1Controller.text) ?? 0,
                              poland2:
                                  int.tryParse(poland2Controller.text) ?? 0,
                              poland3:
                                  int.tryParse(poland3Controller.text) ?? 0,
                              mexico1:
                                  int.tryParse(mexico1Controller.text) ?? 0,
                              mexico2:
                                  int.tryParse(mexico2Controller.text) ?? 0,
                              mexico3:
                                  int.tryParse(mexico3Controller.text) ?? 0,
                              argentina1:
                              ...
                              saudiarabia1:
                                  int.tryParse(saudiarabia1Controller.text) ??
                                      0,
                              saudiarabia2:
                                  int.tryParse(saudiarabia2Controller.text) ??
                                      0,
                              saudiarabia3:
                                  int.tryParse(saudiarabia3Controller.text) ??
                                      0,
                            );
                      },
                    ),
